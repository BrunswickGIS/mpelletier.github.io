        ...
        var clazz = declare([BaseWidget], {
            ...
            postCreate: function () {
                ...
                if (this.config.showTitle === false) {
                    ...
                    dojo.setAttr(this.layerListTitle, "style", obj);
            ...
            //test function for API Testing
            //changeFolderVisibilityTesting: function (objFolderArr) {
            //    var objFolderArray = [{ foldername: "Imageries", status: false },
            //        { foldername: "Demo", status: true }
            //    ];
            //    this.changeFolderVisibility(objFolderArray);
            //},
