  ...
  return declare([_WidgetBase, _TemplatedMixin], {
    ...
    cancelFilter: function() {
      ...
      this._updateLayerInfoStatus(text);
          ...
          if (text != "")
          {
              //this.layerListWidget.layerListView.foldOrUnfoldAllLayers(false);
              this.layerListWidget.layerListView.ExpandFolders(); //expand only folders, as already layers are expanded
          }
              
          else
              {
              this.layerListWidget.layerListView.collapseLayers(true);
          }
    },
